...
<title>Category <?=category.getTitle()?> - Page <?=current_page.toString()?> - <?=setting.getSiteName()?></title>
<meta name="title" content="Category <?=category.getTitle()?> - Page <?=current_page.toString()?> - <?=setting.getSiteName()?>"/>			
<meta name="description" content="Category <?=category.getTitle()?>. <?=setting.getSiteDescription()?>"/>
<meta name="keywords" content="<?=category.getTitle()?>, <?=setting.getSiteKeyword()?>"/>	
<meta name="generator" content="Blogger 2.0"/>
	
<meta property="og:url" content="<?=page_url?>"/>
<meta property="og:title" content="Category <?=category.getTitle()?> - Page <?=current_page.toString()?> - <?=setting.getSiteName()?>"/>
<meta property="og:description" content="Category <?=category.getTitle()?>. <?=setting.getSiteDescription()?>"/>	
        	...
        	<div class="container">
                <div class="row-fluid">
                    ...
                    <div id="mainContent" class="span8">
                    	...
                    	<h2 class="heading">Category : <?=category.getTitle()?></h2>
                    	<?
						...
						?>                    	                    	                                                       
                            <ul class="pager">
                            	...
                            	?>
	                                <li class="previous">
	                                    <a href="/category/<?=category.getAlias()?>/?page=<?=(current_page+1).toString()?>">&larr; Older Entries</a>
	                                </li>
                                <?
                                	}
                                ?>
                            	...
                            	?>
	                                <li class="next">
	                                    <a href="/category/<?=category.getAlias()?>/?page=<?=(current_page-1).toString()?>">Newer Entries &rarr;</a>	                                    
	                                </li>
                                <?
                                	}
                                ?>                              
