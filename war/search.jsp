...
<title>Search result for <?=keyword?> - Page <?=current_page.toString()?>- <?=setting.getSiteName()?></title>
<meta name="title" content="Search result for <?=keyword?> - Page <?=current_page.toString()?>- <?=setting.getSiteName()?>"/>			
<meta name="description" content="Search result for <?=keyword?>, <?=setting.getSiteTitle()?>"/>
<meta name="keywords" content="<?=keyword?>, <?=setting.getSiteKeyword()?>"/>	
<meta name="generator" content="Blogger 2.0"/>
	
<meta property="og:url" content="<?=page_url?>"/>
<meta property="og:title" content="Search result for <?=keyword?> - Page <?=current_page.toString()?>- <?=setting.getSiteName()?>"/>
<meta property="og:description" content="Search result for <?=keyword?>, <?=setting.getSiteTitle()?>"/>	
        	...
        	<div class="container">
                <div class="row-fluid">
                    ...
                    <div id="mainContent" class="span8">
                    	...
                    	<h2 class="heading">Search result for : <?=keyword?></h2>
                    	<?
						...
						?>                    	                    	                                                       
                            <ul class="pager">
                            	...
                            	?>
	                                <li class="previous">
	                                    <a href="/search/<?=keyword?>/?page=<?=(current_page+1).toString()?>">&larr; Older Entries</a>
	                                </li>
                                <?
                                	}
                                ?>
                            	...
                            	?>
	                                <li class="next">
	                                    <a href="/search/<?=keyword?>/?page=<?=(current_page-1).toString()?>">Newer Entries &rarr;</a>	                                    
	                                </li>
                                <?
                                	}
                                ?>                              
                        ...
                        <div id="sidebar">
                            <div class="box">
                                <form action="" method="get" onsubmit="location.href='/search/' + encodeURIComponent(this.search.value).replace(/ /g, '+'); return false;" class="form-inline">   
		                            <input type="text" class="input-block-level" name="search" id="s" placeholder="search this site" value="<?=keyword?>">
		                        </form>
                            </div>                 
